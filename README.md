...
| ---- | ---- | --- | ---- | ---- | ---- 
| [코난팡] (#코난팡-(고난탐정-코난))| C++ | 1개월 | Window API | Puzzle| 명탐정 코난 모티브, 쓰리매치 창작 게임
| [스페이스 슈터 유니티쨩](#스페이스-슈터-유니티쨩)| Unity 3D, C# | 2주 | Window, Android | FPS | Unity 3D 첫 작품, <절대강좌!유니티> 예제 어레인지 
...
---------
# 코난팡 (고난탐정 코난) 
![명탐정 코난 모티드 쓰리매치게임 타이틀이미지](imgForPortfolio/conan_title.gif) ![명탐정 코난 모티드 쓰리매치게임 플레이이미지](imgForPortfolio/conan_play.gif) ![명탐정 코난 모티드 쓰리매치게임 랭킹등록 및 확인 이미지](imgForPortfolio/conan_score.gif)

*게임에서 느껴보는 1분간의 숨막히는 추격전.* 
...
# 스페이스 슈터 유니티쨩
![스페이스 슈터 유니티쨩 플레이 이미지](imgForPortfolio/unitychan_shooter.gif)
...
| 타이틀 | 개발환경 | 제작기간 | 플레이 환경 |  카테고리 | 비고 
| ---- | ---- | --- | ---- | ---- | ---- 
| [스페이스 슈터 유니티쨩](#스페이스-슈터-유니티쨩) | Unity3D, C# | 2주 | Window, Android | FPS | Unity3D 첫 작품, <절대강좌!유니티> 예제 어레인지 
